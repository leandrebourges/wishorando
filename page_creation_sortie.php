        ...
        <div class="contenu_page">
            <div class="form-container">
                <form action="php_requests/insert_sortie.php" method="POST">
                    ...
                    <!-- type = button pour pas que ça essaye d'envoyer le formulaire -->
                    <button type="button" id="bouton_import">
                        Importer une sortie
                    </button>

                    <!-- input caché qui pour que l'utilisateur puisse sélectionner le json qu'il veut importer -->
                    <!-- on va ensuite cliquer dessus quand on clique sur bouton import -->
                    <!-- on fait comme ça car plus facile de rendre le bouton joli -->
                    <input type="file" id="import_json" accept="application/json" hidden>
